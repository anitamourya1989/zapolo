				...
				<header class="entry-header">
					<div class="entry-meta">
						<?php
							...
							printf( __( '<a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a><span class="sep">/</span><span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span><span class="sep">/</span><a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a>', 'athemes' ),
